...
var variants_tsx_1 = require("@/components/ui/button/variants.tsx");
function Button(_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(Comp, __assign({ "data-slot": 'button', className: (0, utils_ts_1.cn)((0, variants_tsx_1.default)({ variant: variant, size: size, className: className })) }, props)));
}
