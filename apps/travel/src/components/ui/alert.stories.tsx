...
export const AllVariants: Story = {
  render: () => (
    <ComponentStory
      ...
      description='All available alert variants with icons and descriptions'
...
export const WithIcons: Story = {
  render: () => (
    <ComponentStory
      ...
      description='Alerts enhanced with contextual icons for better visual communication'
    ...
    >
      <div className='space-y-4'>
        ...
        <Alert>
          ...
          <AlertDescription>
            Your flight departure time has been moved to 2:30 PM. Please arrive at the airport 2
            hours early.
          </AlertDescription>
        </Alert>
...
export const TripOrganizationExamples: Story = {
  render: () => (
    <ComponentStory
      title='Trip Organization Alerts'
      description='Real-world examples of alerts in a trip planning context'
...
export const WithoutTitle: Story = {
  render: () => (
    <ComponentStory
      title='Alerts Without Titles'
      description='Simple alerts with just descriptions for quick notifications'
...
export const LongContent: Story = {
  render: () => (
    <ComponentStory
      title='Alerts with Long Content'
      description='How alerts handle longer text content and multiple paragraphs'
    ...
    >
      <div className='space-y-4'>
        <Alert>
          ...
          <AlertDescription>
            <p>
              We highly recommend purchasing travel insurance for your upcoming European trip.
              Travel insurance can protect you from unexpected costs related to:
            </p>
...
export const Interactive: Story = {
  render: () => (
    <ComponentStory
      title='Interactive Alert Demo'
      description='Clickable alerts demonstrating user interactions'
      background='gradient-green'
    >
      <div className='space-y-4'>
        <Alert
