...
export const InteractiveBadges: Story = {
  render: () => (
    <div className='space-y-6 max-w-4xl'>
      <div className='space-y-4'>
        <div>
          <h4 className='text-sm font-medium text-gray-600 mb-2'>Filter Tags (Click to toggle)</h4>
          <div className='flex gap-2 flex-wrap'>
            <Badge
              variant='outline'
      ...
      <div className='space-y-4'>
        ...
        <div>
          ...
          <div className='flex gap-3 flex-wrap'>
            ...
            <Badge variant='outline' className='opacity-50 cursor-not-allowed pointer-events-none'>
              Disabled Outline
            </Badge>
          </div>
        </div>
  ...
  render: args => (
    <div className='text-center space-y-4 max-w-2xl'>
      ...
      <div className='p-4 bg-blue-50 rounded-lg border border-blue-100'>
        ...
        <ul className='text-sm text-blue-800 space-y-1'>
          <li>• Use Storybook controls to change the variant</li>
